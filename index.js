...
//   }
//   set(r, g, b) {
//       this.setState({r: this.clamp(r), g: this.clamp(g), b: this.clamp(b)});
//   }
//   hueRotate(angle = 0) {
...
//        this.setState({r: this.clamp(this.r * slope + intercept * 255), g: this.clamp(this.g * slope + intercept * 255), b: this.clamp(this.b * slope + intercept * 255)});
//   }
//   invert(value = 1) {
//       this.setState({r: this.clamp((value + this.r / 255 * (1 - 2 * value)) * 255), g: this.clamp((value + this.g / 255 * (1 - 2 * value)) * 255), b: this.clamp((value + this.b / 255 * (1 - 2 * value)) * 255)});
//   }
//   hsl() {
//     const r = this.r / 255;
//     const g = this.g / 255;
    ...
    value: function render() {
      ...
      if (Array.isArray(this.props.color)) {
        ...
        if (this.props.color.includes('#')) {
          ...
          desiredColor = this.hexToRgb(namedColors[this.props.color]);
        }
      }
